 ...
 * 
 * @see net.sf.asterisk.manager.action.ZapShowChannelsAction
 * @see net.sf.asterisk.manager.event.ZapShowChannelsEvent
 * 
 * @author srt
 * @version $Id: ZapShowChannelsCompleteEvent.java,v 1.2 2005/02/23 22:50:58 srt Exp $
 */
