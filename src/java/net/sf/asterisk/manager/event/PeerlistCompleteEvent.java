 ...
 * @see net.sf.asterisk.manager.action.SIPPeersAction
 * @see net.sf.asterisk.manager.action.SIPShowPeerAction
 * @author srt
 * @version $Id: PeerlistCompleteEvent.java,v 1.1 2005/07/18 14:53:08 srt Exp $
 * @since 0.2
 */
