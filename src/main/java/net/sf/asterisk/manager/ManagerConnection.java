 ...
 * 
 * @see net.sf.asterisk.manager.ManagerConnectionFactory
 * @author srt
...
public interface ManagerConnection
{
     ...
     * @see net.sf.asterisk.manager.action.LogoffAction
     */
     ...
     * {@link net.sf.asterisk.manager.action.StatusAction}, the
     * {@link net.sf.asterisk.manager.action.QueueAction} or the
     * {@link net.sf.asterisk.manager.action.AgentsAction}.
     * 
     * @param action the action to send to the Asterisk server
     ...
     * {@link net.sf.asterisk.manager.event.ManagerEvent} is receiced from the
     * Asterisk server.<br>
