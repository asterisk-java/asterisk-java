...
public class ManagerConnectionImpl implements ManagerConnection, Dispatcher
{
	...
	public synchronized void login(String eventMask) throws IOException, AuthenticationFailedException,
			TimeoutException
	{
	 ...
	 */
	protected synchronized void doLogin(long timeout, String eventMask) throws IOException,
	...
	public void sendAction(ManagerAction action, SendActionCallback callback) throws IOException,
			IllegalArgumentException, IllegalStateException
	{
	...
	public ResponseEvents sendEventGeneratingAction(EventGeneratingAction action) throws IOException,
