 ...
 * for example to a MeetMe room.<br>
...
public class RedirectAction extends AbstractManagerAction
{
     ...
     * given context, extension, priority triple.<br>
    ...
    /**
     * Creates a new RedirectAction that redirects the given channels to the
     * given context, extension, priority triples.<br>
    ...
    /**
     * Returns the destination context for the additional channel.<br>
    ...
    /**
     * Sets the destination context for the additional channel.<br>
     * This property is only used by BRIstuffed Asterisk servers.
     * 
    ...
    /**
     * Sets the destination extension for the additional channel.<br>
     * This property is only used by BRIstuffed Asterisk servers.
     * 
    ...
    /**
     * Returns the destination priority for the additional channel.<br>
     * This property is only used by BRIstuffed Asterisk servers.
     * 
    ...
    /**
     * Sets the destination priority for the additional channel.<br>
     * This property is only used by BRIstuffed Asterisk servers.
     * 
