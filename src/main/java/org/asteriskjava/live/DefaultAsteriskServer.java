...
public class DefaultAsteriskServer implements AsteriskServer
{
     ...
     */
    public DefaultAsteriskServer(String hostname, String username,
	    String password)
    {
     ...
     * @param password the password to use for login
     */
    public DefaultAsteriskServer(String hostname, int port, String username,
	    String password)
    {
	final ManagerConnection connection;
    ...
    protected DefaultManagerConnection createManagerConnection(String hostname,
    ...
    {
	impl.originateToApplicationAsync(channel, application, data, timeout,
		callerId, variables, cb);
    }
    ...
    public void originateToExtensionAsync(String channel, String context,
	    ...
	    throws ManagerCommunicationException
    {
	impl.originateToExtensionAsync(channel, context, exten, priority,
		timeout, callerId, variables, cb);
    }
