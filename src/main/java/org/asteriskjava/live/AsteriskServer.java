...
public interface AsteriskServer
{
     ...
     * @throws ManagerCommunicationException if the originate action cannot be sent to Asterisk
     */
    void originateToExtensionAsync(String channel, String context, String exten, int priority, long timeout, Map<String, String> variables, OriginateCallback callback) 
        throws ManagerCommunicationException;
     ...
     * @throws ManagerCommunicationException if the originate action cannot be sent to Asterisk
     */
    void originateToApplicationAsync(String channel, String application, String data, long timeout, Map<String, String> variables, OriginateCallback callback) 
        throws ManagerCommunicationException;
