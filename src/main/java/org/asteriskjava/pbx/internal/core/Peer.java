...
{
	static private Logger logger = Logger.getLogger(Peer.class);

	private final EndPoint peerEndPoint;

	/**
	 * Used to track the list of channels associated with this peer.
	 * 
	 * I think there would normally only be a single channel unless we are in
	 * the middle of a transfer or the phone has two calls up.
	 */
	 ...
	 * 
	 * Be warned a peer can have multiple calls associated with it.
	 * 
	 * @param b
	 * @throws Exception
	 */
