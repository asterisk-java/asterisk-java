...
public abstract class ChannelEventHelper extends ManagerEvent implements ChannelEvent
{
    ...
    public static ChannelProxy registerChannel(final String channelName, final String uniqueId, final String callerIdNum,
            final String callerIdName) throws InvalidChannelName
    {
        final AsteriskPBX pbx = (AsteriskPBX) PBXFactory.getActivePBX();

        final ChannelProxy channel = pbx.internalRegisterChannel(channelName, uniqueId);
