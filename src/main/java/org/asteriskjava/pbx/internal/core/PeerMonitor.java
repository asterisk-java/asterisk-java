...
import org.asteriskjava.pbx.internal.asterisk.wrap.actions.SipPeersAction;
import org.asteriskjava.pbx.internal.asterisk.wrap.actions.StatusAction;
...
public class PeerMonitor extends EventListenerBaseClass implements Runnable
{
	...
	static Logger logger = Logger.getLogger(PeerMonitor.class);
