...
public class CallerIDImpl implements CallerID
{
	...
	private static final Logger logger = Logger.getLogger(CallerIDImpl.class);
	 ...
	 * 
	 * @param number
	 *            - if null then we store an empty string.
	 * @param name
	 *            - if null then we store an empty string.
	 */
	 ...
	 * 
	 * If both firstname and lastname are null then the name component will be
	 * an empty string.
	 * 
	 * @param firstname
	 *            the person's firstname, may be null.
	 * @param lastname
	 *            the person's lastname, may be null
	 * @param number
	 *            the phone number.
	 * @return
	 */
