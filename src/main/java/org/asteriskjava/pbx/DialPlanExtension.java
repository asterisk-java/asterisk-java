 ...
 * 
 * This class primarily exists to stop common mistakes that can occur if we pass
 * this around as a simple string.
 * 
 * @author bsutton
 * 
 */
public class DialPlanExtension implements EndPoint
{
	...
	private static final Logger logger = Logger.getLogger(DialPlanExtension.class);
