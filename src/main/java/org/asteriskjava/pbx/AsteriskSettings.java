...
public interface AsteriskSettings
{
	...
	/**
	 * The port no. that the asterisk manager api listens on.
	 * This should be 5060 unless you have re-configured the manager api.
	 * @return the port no.
	 */
    ...
    /**
     * This MUST match the section header (e.g. '[myconnection]') in manager.conf
     * @return
     */
     ...
     * Just make certain that the base address doesn't overlap any conference 
     * rooms you are currently running on your pbx.
     ...
     * All version after 1.8 support bridging so normally you should returm false;
     * 
    ...
    /**
     * Return an asterisk dialplan extension (within the above Management Context)
    ...
    /**
     * The time (in seconds) to wait for a dial attempt to be answered before giving up.
     * Recommend a value of 30.
     * @return
     */
    int getDialTimeout();

    /**
     * Return the SIP header to be used to force a handset to auto-answer when dialed.
     * e.g. For Yealink/Snom use return "Call-Info:\; answer-after=0";
     * @return
     */
	...
	/**
	 *  Return true if the telephony tech you are dialing from can reliably detect
	 *  hangups. (for SIP set to true, POTS set false). 
	 * @return
	 */
