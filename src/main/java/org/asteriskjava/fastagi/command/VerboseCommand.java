...
/**
 * Sends a message to the Asterisk console via the verbose message system.<br>
 * Always returns 1.
 * 
 * @author srt
 * @version $Id$
...
public class VerboseCommand extends AbstractAgiCommand
{
     ...
     * @param level the verbosity level to use.<br>
     *            Must be in [1..4]
     */
