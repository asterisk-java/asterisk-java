 ...
 * <p>
 * See: <a href="https://wiki.asterisk.org/wiki/display/AST/Asterisk+18+AGICommand_say+time">AGI Command SAY TIME (Asterisk 18)</a>
 *
 * @author srt
 */
public class SayTimeCommand extends AbstractAgiCommand {
     ...
     *
     * @param escapeDigits the time that allow the user to interrupt this command or <code>null</code> for none.
     */
