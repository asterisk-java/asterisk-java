...
/**
 * AGI Command: <b>DATABASE DELTREE</b>
 * <p>
 * Deletes a family or specific keytree within a family in the Asterisk database.<br>
 * Returns 1 if successful, 0 otherwise.
 * <p>
 * See: <a href="https://wiki.asterisk.org/wiki/display/AST/Asterisk+18+AGICommand_database+deltree">AGI Command DATABASE DELTREE (Asterisk 18)</a>
 *
 * @author srt
 */
