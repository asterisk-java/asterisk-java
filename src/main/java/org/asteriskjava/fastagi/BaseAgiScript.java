...
public abstract class BaseAgiScript implements AgiScript
{
     ...
     * @since 0.3
     */
    protected void recordFile(String file, String format, String escapeDigits,
     ...
     * @since 0.3
     */
    protected void controlStreamFile(String file) throws AgiException
    {
     ...
     * @since 0.3
     */
    protected char controlStreamFile(String file, String escapeDigits) throws AgiException
    {
     ...
     * @since 0.3
     */
    protected char controlStreamFile(String file, String escapeDigits, int offset) throws AgiException
    {
     ...
     * @since 0.3
     */
    protected char controlStreamFile(String file, String escapeDigits,
