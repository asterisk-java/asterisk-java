...
class ManagerReaderImplTest {
    ...
    void testWorkaroundForAsteriskBug13319() throws Exception {
        ...
        assertEquals(1234, rtcpReceivedEvent.getFromPort(), "Invalid from port on RtcpReceivedEvent");
        assertEquals(999L, rtcpReceivedEvent.getHighestSequence(), "Invalid highest sequence on RtcpReceivedEvent");
