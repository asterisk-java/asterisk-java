...
class RtcpReceivedEventTest {
    ...
    void testFrom() {
        ...
        assertEquals(1234, rtcpReceivedEvent.getFromPort());
    }

    @Test
    void testPt() {
        rtcpReceivedEvent.setPt("200(Sender Report)");
        assertEquals(200L, rtcpReceivedEvent.getPt());
        assertEquals(RtcpReceivedEvent.PT_SENDER_REPORT, rtcpReceivedEvent.getPt());
    }
    ...
    void testRtt() {
        ...
        assertEquals(12345, rtcpReceivedEvent.getRtt());
    }
}
