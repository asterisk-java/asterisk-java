 ...
 * <p>
 * See: <a href="https://wiki.asterisk.org/wiki/display/AST/Asterisk+18+AGICommand_say+number">AGI Command SAY NUMBER (Asterisk 18)</a>
 *
 * @author srt
 */
public class SayNumberCommand extends AbstractAgiCommand {
     ...
     *
     * @param number       the number to say.
     * @param escapeDigits contains the number that allow the user to interrupt this command.
     */
     ...
     *
     * @param escapeDigits the number that allow the user to interrupt this command or <code>null</code> for none.
     */
